...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mt-4 mb-4">Inscripciones</h1>
        <a href="agregar_inscripcion.php" class="btn btn-success">Agregar Inscripción</a>
    </div>
    <table class="table">
        ...
        <tbody>
            ...
            $inscripciones = $controller->getAllInscripciones();

            while ($inscripcion = $inscripciones->fetch(PDO::FETCH_ASSOC)) :
            ?>
                <tr>
